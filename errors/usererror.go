...
var (
	...
	ErrLoginUser                 = NewUserError(http.StatusInternalServerError, "error login in user")
	ErrUpdatingUserResource      = NewUserError(http.StatusInternalServerError, "error updating user resources") //server error, error updating user resources      //server error ,error login in user
)
